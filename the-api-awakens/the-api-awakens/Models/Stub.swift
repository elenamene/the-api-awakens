...
struct Stub {
    ...
    static var vehicles: [Vehicle] {
        let snowspeeder = Vehicle(name: "Snowspeeder", model: "t-47 airspeeder", manufacturer: "Incom corporation", cost: "150000", length: "4.5", maxAtmospheringSpeed: "650", crew: "2", passengers: "0", vehicleClass: "airspeeder", films: [])
    ...
    static var starships: [Starship] {
        ...
        let executor = Starship(name: "Executor", model: "Executor-class star dreadnought", manufacturer: "Kuat Drive Yards, Fondor Shipyards", cost: "1143350000", length: "19000", maxAtmospheringSpeed: "30", crew: "279144", passengers: "38000", mglt: "40", hyperdriveRating: "2.0", starshipClass: "Star dreadnought", films: [])
